#!/bin/bash
# Display Mode Configuration - MacBook Air
# Run discover.sh to find your DDC input values, then fill in below.
#
# Note: The Air typically only drives the BenQ via USB-C in split modes.
# DDC values are still needed for switching the BenQ input when this
# machine triggers a mode change.
